 ...
 */
package com.facebook.tsdb.pulse.server.gnuplot;
...
public abstract class GnuplotProcess {
    ...
    public GnuplotProcess() throws Exception {
        ...
        gnuplotStdin = new BufferedWriter(
                new OutputStreamWriter(gnuplot.getOutputStream()));
        gnuplotStderr = new BufferedReader(
                new InputStreamReader(gnuplot.getErrorStream()));
    }
    ...
    InterruptedException {
        ...
        BufferedWriter writer = new BufferedWriter(
                new OutputStreamWriter(bash.getOutputStream()));
