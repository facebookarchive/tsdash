 ...
 */
package com.facebook.tsdb.pulse.server.data.hbase;

import java.util.Arrays;

import org.apache.hadoop.hbase.util.Bytes;

import com.facebook.tsdb.pulse.server.model.ID;
import com.facebook.tsdb.pulse.server.model.Tag;
import com.facebook.tsdb.pulse.server.model.TagsArray;
...
public class RowKey {
    ...
    public TagsArray getTags(ID[] tagsPri) {
        ...
        for (int i = 0; i < tags.length; i++) {
            tags[i] = new Tag(
               ...
               Arrays.copyOfRange(key, offset + ID.BYTES, offset + 2 * ID.BYTES),
               idMap
            );
            offset += tagBytes;
        }
    ...
    public String toString() {
        ...
        for (int i = 0; i < tagsNo; i++) {
            ...
            ret += " " + UnsignedBytes.join(".", Arrays.copyOfRange(key, 
                    offset, offset + 2 * ID.BYTES));
        }
        return ret;
    }
}
