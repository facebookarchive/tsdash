...
import com.facebook.tsdb.pulse.client.event.ErrorEvent;
import com.facebook.tsdb.pulse.client.event.MetricEvent;
import com.facebook.tsdb.pulse.client.event.MetricHeaderEvent;
import com.facebook.tsdb.pulse.client.event.MetricHeaderEventHandler;
...
public class MetricPresenter implements Presenter {
    ...
    private TagWidget createTagWidget(Metric metric, String tag) {
        ...
        if (metric.tags.containsKey(tag)) {
            return new com.facebook.tsdb.pulse.client.ui.TagWidget(tag,
                    metric.tags.get(tag));
        }
        ...
        return new com.facebook.tsdb.pulse.client.ui.TagWidget(tag, options);
    }
    ...
    private MetricWidget addMetric(final Metric metric) {
        final MetricWidget metricWidget = 
                new com.facebook.tsdb.pulse.client.ui.MetricWidget(metric.name);
	...
	private void addMetricOption(final String metricName) {
	    MetricOptionWidget optionWidget =
	            new com.facebook.tsdb.pulse.client.ui.MetricOptionWidget();
