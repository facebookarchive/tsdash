...
import com.facebook.tsdb.pulse.client.event.GraphEventHandler;
...
public class AutoreloadPresenter implements Presenter {
	...
	private AutoreloadWidget widget;
	...
	private void bindWidget() {
		ClickHandler toggleHandler = new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				eventBus.fireEvent(
					new AutoReloadEvent(AutoReloadEvent.Action.ENABLE,
							widget.isReloading(),
							getPeriodOption())
					);
			}
		...
		widget.period().addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				// fire period change
				eventBus.fireEvent(
					new AutoReloadEvent(AutoReloadEvent.Action.PERIOD_CHANGE,
							widget.isReloading(),
							getPeriodOption())
					);
				fireTimeCount();
