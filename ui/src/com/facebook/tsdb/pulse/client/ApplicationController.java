 ...
 */
package com.facebook.tsdb.pulse.client;
...
import com.facebook.tsdb.pulse.client.event.AutoReloadEvent;
import com.facebook.tsdb.pulse.client.event.AutoReloadEventHandler;
import com.facebook.tsdb.pulse.client.event.KeyboardShortcutEvent;
import com.facebook.tsdb.pulse.client.event.KeyboardShortcutHandler;
import com.facebook.tsdb.pulse.client.event.MetricEvent;
import com.facebook.tsdb.pulse.client.event.MetricEventHandler;
import com.facebook.tsdb.pulse.client.event.PlotOptionsEvent;
import com.facebook.tsdb.pulse.client.event.PlotOptionsEventHandler;
import com.facebook.tsdb.pulse.client.event.StateChangeEvent;
import com.facebook.tsdb.pulse.client.event.TagEvent;
import com.facebook.tsdb.pulse.client.event.TagEventHandler;
import com.facebook.tsdb.pulse.client.event.TimeRangeChangeEvent;
import com.facebook.tsdb.pulse.client.event.TimeRangeChangeEventHandler;
import com.facebook.tsdb.pulse.client.event.ViewChangeEvent;
import com.facebook.tsdb.pulse.client.event.ViewChangeEventHandler;
import com.facebook.tsdb.pulse.client.event.StateChangeEvent.StateChange;
import com.facebook.tsdb.pulse.client.model.ApplicationState;
import com.facebook.tsdb.pulse.client.model.Metric;
import com.facebook.tsdb.pulse.client.presenter.AutoreloadPresenter;
import com.facebook.tsdb.pulse.client.presenter.ErrorPresenter;
import com.facebook.tsdb.pulse.client.presenter.GraphPresenter;
import com.facebook.tsdb.pulse.client.presenter.LogPresenter;
import com.facebook.tsdb.pulse.client.presenter.MetricPresenter;
import com.facebook.tsdb.pulse.client.presenter.PlotOptionsPresenter;
import com.facebook.tsdb.pulse.client.presenter.Presenter;
import com.facebook.tsdb.pulse.client.presenter.TimePresenter;
import com.facebook.tsdb.pulse.client.presenter.TopMenuPresenter;
import com.facebook.tsdb.pulse.client.presenter.WrapPresenter;
import com.facebook.tsdb.pulse.client.service.HTTPService;
import com.facebook.tsdb.pulse.client.ui.AutoreloadWidget;
import com.facebook.tsdb.pulse.client.ui.ErrorWidget;
import com.facebook.tsdb.pulse.client.ui.GraphWidget;
import com.facebook.tsdb.pulse.client.ui.LogWidget;
import com.facebook.tsdb.pulse.client.ui.MetricsFormWidget;
import com.facebook.tsdb.pulse.client.ui.PlotOptionsWidget;
import com.facebook.tsdb.pulse.client.ui.SelectTimeWidget;
import com.facebook.tsdb.pulse.client.ui.TopMenuWidget;
...
Presenter{
	...
	private TopMenuPresenter topPresenter;
	private ErrorPresenter errorPresenter;
	private MetricPresenter metricPresenter;
	private Map<String, ArrayList<Presenter>> viewPresenters =
	...
	public ApplicationController(HandlerManager eventBus, HTTPService service) {
		...
		viewPresenters.put(ViewChangeEvent.View.GRAPH.toString(), 
				graphPresenters);
		viewPresenters.put(ViewChangeEvent.View.LOG.toString(), 
				logPresenters);
	}
